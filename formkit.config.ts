...
const config: DefaultConfigOptions = {
  plugins: [createProPlugin("fk-bbd1b16826", inputs)],
  config: {
    classes: generateClasses({
      global: {
        fieldset: "row rounded mx-0",
        ...
        message: "text-racq-error-red mb-1 text-sm md:pl-[200px]",
      ...
      "family:button": {
        input:
          "$reset inline-flex items-center text-[1.125rem] font-[600] py-[12px] px-[21px] rounded focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
        wrapper: "mb-1",
      ...
      text: {
        label: "float-md-left w-[180px] text-[.9375rem] mr-[20px]",
        inner: "max-w-[100%]",
        input: "max-w-[100%]",
        outer: "w-[90%]",
      },
      radio: {
        outer: "w-[90%]",
        options: "d-flex racq-radio h-[40px]",
        decorator: "d-none",
        legend: "float-md-left w-[180px] text-[.9375rem] mr-[20px]",
        label: "px-[20px] py-1 text-racq-navy font-bold",
      },
      range: {
      ...
      textarea: {
        ...
        input:
          "block w-full min-w-[330px] h-32 px-3 py-3 border-none text-base text-gray-700 placeholder-gray-400 focus:shadow-outline",
      },
      ...
      autocomplete: {
        ...
        inner: "relative focus:bg-racq-blue-background",
        listitem: "hover:bg-racq-blue-background bg-white pl-0 cursor-pointer",
        option: "grow text-ellipsis hover:bg-racq-blue-background",
        selectionWrapper: `
